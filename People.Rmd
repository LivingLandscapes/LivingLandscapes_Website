...
Lab members listed alphabetically by last name. Last updated: Dec 1, 2025.
...
people_tbl <- data.frame(
  Members = c("Caleb Roberts", "Paul Akpejeluh", "Anne Puchalsky", "Michael Ferrara", "Lindsey LaBrie", "Lauren Luther", "Evan Wilson", "Gracie Whatley"),
  Roles = c("PI", "PhD Student", "Master's Student", "PhD Student",  "PhD Student", "Master's Student", "Postdoctoral Fellow", "Master's Student"),
  Contact = c("cr065@uark.edu", "pa024@uark.edu", "annep@uark.edu", "mcf017@uark.edu",  "llabrie@uark.edu", "leluther@uark.edu", "ew169@uark.edu", "TBD"),
  Bios = c(
