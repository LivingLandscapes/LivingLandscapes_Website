...
Lab members listed alphabetically by last name. Last updated: August 4, 2025.
...
people_tbl <- data.frame(
  Members = c("Caleb Roberts", "Paul Akpejeluh", "Anne Puchalsky", "Michael Ferrara", "Lindsey LaBrie", "Lauren Luther", "Evan Wilson", "Andrew Ruegsegger"),
  Roles = c("PI", "PhD Student", "Master's Student", "Master's Student",  "PhD Student", "Master's Student", "Postdoctoral Fellow", "PhD Student"),
  Contact = c("cr065@uark.edu", "pa024@uark.edu", "annep@uark.edu", "mcf017@uark.edu",  "llabrie@uark.edu", "leluther@uark.edu", "ew169@uark.edu", "ajruegse@uark.edu"),
  Bios = c(
