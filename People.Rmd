...
Lab members listed alphabetically by last name. Last updated: December 11, 2023.
...
people_tbl <- data.frame(
  Members = c("Caleb Roberts", "Paul Akpejeluh", "Vinita Karki", "Michael Ferrara", "Jess Schmit", "Lauren Berry", "Ken Wilson", "Lindsey LaBrie"),
  Roles = c("PI", "PhD Student", "PhD Student", "Master's Student", "Master's Student", "Master's Student", "Master's Student", "PhD Student"),
  Contact = c("cr065@uark.edu", "paulakpejeluh23@gmail.com", "vinicarkey8@gmail.com", "mcf017@uark.edu",  "jmschmit@uark.edu", "llberry@uark.edu", "kw101@uark.edu", "llabrie@uark.edu"),
  Bios = c(
