...
Lab members listed alphabetically by last name. Last updated: March 11, 2024.
...
people_tbl <- data.frame(
  ...
  Contact = c("cr065@uark.edu", "pa024@uark.edu", "vinicarkey8@gmail.com", "mcf017@uark.edu",  "jmschmit@uark.edu", "llberry@uark.edu", "kw101@uark.edu", "llabrie@uark.edu"),
  Bios = c(
