...
Lab members listed alphabetically by last name. Last updated: June 14, 2021.
...
kbl(people_tbl) %>%
  ...
  column_spec(1, bold = TRUE, border_right = FALSE, background = "#999990", 
              width = "10em") %>%
  column_spec(2, bold = FALSE, border_right = FALSE, width = "15em") %>%
  column_spec(3, bold = FALSE, border_right = TRUE, background = "#999990", 
              width = "10em") %>%
