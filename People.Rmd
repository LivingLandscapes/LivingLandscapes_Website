...
Lab members listed alphabetically by last name. Last updated: October 23, 2023.
...
people_tbl <- data.frame(
  Members = c("Caleb Roberts", "Vinita Karki", "Michael Ferrara", "Mike Shaw", "Jess Schmit", "Lauren Berry", "Ken Wilson", "Lindsey LaBrie"),
  Roles = c("PI", "PhD Student", "Master's Student", "Master's Student", "Master's Student", "Master's Student", "Master's Student", "PhD Student"),
  Contact = c("cr065@uark.edu", "vinicarkey8@gmail.com", "mcferrara44@gmail.com", "ms161@uark.edu", "jmschmit@uark.edu", "llberry@uark.edu", "kw101@uark.edu", "llabrie@uark.edu"),
  Bios = c(
