...
Lab members listed alphabetically by last name. Last updated: May 14, 2024.
...
people_tbl <- data.frame(
  Members = c("Caleb Roberts", "Paul Akpejeluh", "Vinita Karki", "Michael Ferrara", "Jess Schmit", "Lauren Berry", "Ken Wilson", "Lindsey LaBrie", "Lauren Luther"),
  Roles = c("PI", "PhD Student", "PhD Student", "Master's Student", "Post-Master's", "Post-Master's", "Master's Student", "PhD Student", "Undergrad Student"),
  Contact = c("cr065@uark.edu", "pa024@uark.edu", "vkarki@uark.edu", "mcf017@uark.edu",  "jmschmit@uark.edu", "llberry@uark.edu", "kw101@uark.edu", "llabrie@uark.edu", "leluther@uark.edu"),
  Bios = c(
