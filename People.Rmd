...
Lab members listed alphabetically by last name. Last updated: June 2, 2022.
...
people_tbl <- data.frame(
  Members = c("Caleb Roberts", "Percy Marshall", "Mike Shaw", "Jess Schmit", "Lauren Berry", "Ken Wilson"),
  Roles = c("PI", "Master's Student", "Master's Student", "Master's Student", "Master's Student", "Master's Student"),
  Contact = c("cr065@uark.edu", "pmm005@uark.edu", "ms161@uark.edu", "jmschmit@uark.edu", "llberry@uark.edu", "kw101@uark.edu"),
  Bios = c(
