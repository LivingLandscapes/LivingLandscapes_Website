...
Lab members listed alphabetically by last name. Last updated: November 15, 2024.
...
people_tbl <- data.frame(
  Members = c("Caleb Roberts", "Paul Akpejeluh", "Anne Puchalsky", "Michael Ferrara", "Ken Wilson", "Lindsey LaBrie", "Lauren Luther"),
  Roles = c("PI", "PhD Student", "Master's Student", "Master's Student",  "Master's Student", "PhD Student", "Undergrad Student"),
  Contact = c("cr065@uark.edu", "pa024@uark.edu", "TBD", "mcf017@uark.edu",  "kw101@uark.edu", "llabrie@uark.edu", "leluther@uark.edu"),
  Bios = c(
