...
people_tbl <- data.frame(
  Members = c("Caleb Roberts", "Paul Akpejeluh", "Anne Puchalsky", "Michael Ferrara", "Lindsey LaBrie", "Lauren Luther"),
  Roles = c("PI", "PhD Student", "Master's Student", "Master's Student",  "PhD Student", "Undergrad Student"),
  Contact = c("cr065@uark.edu", "pa024@uark.edu", "annep@uark.edu", "mcf017@uark.edu",  "llabrie@uark.edu", "leluther@uark.edu"),
  Bios = c(
