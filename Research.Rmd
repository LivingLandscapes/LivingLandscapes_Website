...
#### Quantifying and communicating successes in savanna restoration on Arkansas private lands

In much of the Southeastern US, lack of fire management and subsequent woody plant encroachment in open pine savannas have led to declines in forest stand health, degraded watershed condition, increased fire risk, and losses of savanna-dependent species, such as Northern Bobwhite. These negative impacts have motivated savanna restoration efforts by private landowners, agencies, and conservation organizations spanning local to regional scales. However, there are critical needs to 1) understand and learn from restoration outcomes and 2) communicate restoration outcomes to landowners and partners. For example, in Arkansas and Louisiana, the Arkansas Game & Fish Commission, Lower Mississippi Valley Joint Venture, American Bird Conservancy, NRCS, and USFWS are working with private landowners to strategize and incentivize savanna restoration under the “Open Pines Regional Conservation Partnership Program”. The Arkansas Unit will help the Open Pines RCPP coalition learn from and communicate successful savanna restoration outcomes to private landowners. In this project, we will 1) quantify outcomes of savanna restoration in terms of forest stand health, 2) quantify outcomes from savanna restoration efforts in terms of quail population and savanna bird community responses, and 3) predict outcomes of savanna restoration efforts on lands that have not received restoration treatments.

</div>
<div class="col-sm-4">
```{r RCPP, fig.cap = "Image credit: Caleb Roberts", out.width='100%', echo=F}
knitr::include_graphics("images/research/Peeples_RCPP_2025.jpg")
```
...
#### Quantifying invasive carp range extents and impacts of invasive carp on native fish communities using environmental DNA metabarcoding

Invasive carp can have strong negative impacts on the economy, fisheries, and species of conservation concern. The invasive carp range continues to expand into more and more of Arkansas’ waters. Thus, there arise two critical needs: 1) understand where the current leading edges of the invasive carp range are located, and 2) to quantify the effects of invasive carp presence on native fish communities. To meet these two needs, we are proposing an Arkansas-wide eDNA metabarcoding study. The objectives of this study are: 1) Document and update the current known extent of invasive carp ranges in Arkansas, and 2) Quantify the effect of invasive carp presence on native fish communities in Arkansas along the invasion gradient. We will accomplish this by collecting eDNA in multiple large Arkansas rivers (e.g., the Arkansas River, the Red River, the White River), conducting DNA metabarcoding analysis, and developing multi-species occupancy models. 


</div>
<div class="col-sm-4">
```{r eDNA, fig.cap = "Image credit: Sam Stukel, USFWS", out.width='100%', echo=F}
knitr::include_graphics("images/research/InvasiveCarp_SamStukel_USFWS.jpg")
```
